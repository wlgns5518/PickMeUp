...
//
// 스킬(SkillState)과 완전히 분리해 둔 것이 이 파일의 요점이다. 원작에서 마법은 버튼 하나로
...
//   2) 마력을 모은다(무방비)          CastState + BeginSpellCast()
...
public partial class UnitController
{
    ...
    // 지금 영창을 시작할 수 있는가. CastState로 들어가는 조건이다.
    ...
    public void BeginSpellCast(in SpellSpec spell, Vector3 aimPoint)
    {
        ...
        // 계속 거짓이었고, AttackState의 거리 벌리기 조건이 다시는 성립하지 않았다 —
