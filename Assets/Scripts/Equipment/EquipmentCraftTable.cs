...
// 장비제작소의 등급 확률표.
//
// 결과 등급의 밑변은 넣은 재료 세 개의 평균 등급이다(CraftRecipe.BaseGradeOf). 아래에서 "재료 등급"은
// 그 밑변을 말한다. 재료가 E면 결과도 E 언저리, S면 결과도 S 언저리다.
//
// 자동 제작은 퍼즐 없이 바로 나오는 대신 재료 등급 그대로 나온다 — 등급에는 운이 끼어들 자리가 없다.
