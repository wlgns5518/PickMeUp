...
public class CharacterSO : ScriptableObject
{
    ...
    public string modelAssetPath;    // Assets/CharacterModels/*.prefab (구성된 3D 캐릭터)
    ...
    [Range(0, 1)] public int hairIndex; // 0 또는 1 (헤어 2종)
    public OutfitSet outfit;            // job에서 파생되지만 명시적으로 보관
    ...
    public void DeleteAssets()
    {
        ...
        try
        {
            ...
            {
                AssetDatabase.DeleteAsset(modelAssetPath);
                modelAssetPath = null;
            }
